...
void pop_params::SetParameters(string pname, int dimvar){
	...
	if(pf.is_open()){
		...
		cout << "Can not read param.pop."<< endl;
		exit(EXIT_FAILURE);
	}	
	//printStrVec(strtype);
	//printStrVec(values);
...
void   pop_params::SetMultiCF(string strtype, string value, int dimvar){
	if(strtype == "int"){
		...
		cout << " ## Error: the second column of multiCliquesFactor" << endl;
		cout << " ##        in param.pop is something wrong. " << endl;
		exit(EXIT_FAILURE);
	}
}
...
void   pop_params::SetSDPsolverOutFile(string strtype, string value){ 
	if(strtype != "string"){
		cout << " ## Error: in param.pop. " << endl;
		cout << " ##        Should be string at the second column of SDPsolverOutFile." << endl;
		exit(EXIT_FAILURE);
	}
...
void   pop_params::SetSdpaDataFile(string strtype, string value){ 
	if(strtype != "string"){
		cout << " ## Error: in param.pop. " << endl;
		cout << " ##        Should be string at the second column of sdpaDataFile." << endl;
		exit(EXIT_FAILURE);
	}
	sdpaDataFile = value;
}
void   pop_params::SetDetailedInfFile(string strtype, string value){ 
	if(strtype != "string"){
		cout << " ## Error: in param.pop. " << endl;
		cout << " ##        Should be string at the second column of detailedInfFile." << endl;
		exit(EXIT_FAILURE);
	}
...
void   pop_params::SetPrintFileName(string strtype, string value){
	...
	if(strtype != "string"){
		cout << " ## Error: in param.pop. " << endl;
		cout << " ##        Should be string at the second column of printFileName." << endl;
		exit(EXIT_FAILURE);
	}
	printFileName = value;
}
...
void   pop_params::SetMethod(string strtype, string value){
	...
	if(strtype != "string"){
		cout << " ## Error: in param.pop. " << endl;
		cout << " ##        Should be string at the second column of Method." << endl;
		exit(EXIT_FAILURE);
	}
	Method = value;
